...
|5.| ORM's y Bases de Datos | 6 | ✅ Finalizado |
|6.| Insertando Registros en la Tabla Usuarios| 20 | ✅  Finalizado. |
|7.| Implementación de la Fucnionalidad (Feature) Recuperación de Contraseña (Password Recovery)| ❌ |✅  Finalizado. |
...
### Creado por: 
Omar de jesus Samapayo Vargas - 240428.